(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    ...
    global.AAAPrimaryTheme = mod.exports;
  }
})(this, function (_exports, _defineProperty2, _react, _styles, _createStyleTheme, _colors) {
  "use strict";
  ...
  _exports.default = AAAThemeProvider;
  _defineProperty2 = _interopRequireDefault(_defineProperty2);
  _react = _interopRequireDefault(_react);
  _createStyleTheme = _interopRequireDefault(_createStyleTheme);
  ...
  theme.typography.h1 = (0, _defineProperty2.default)({
    // Headline
  ...
  theme.typography.h2 = (0, _defineProperty2.default)({
    // Subheadline
    color: theme.typographyValues.color,
    fontFamily: theme.typographyValues.fontFamily,
    fontStyle: theme.typographyValues.fontStyle,
  ...
  theme.typography.subtitle1 = (0, _defineProperty2.default)({
  ...
  theme.typography.body2 = (0, _defineProperty2.default)({
    // Body 2 / Primary Copy
    color: theme.typographyValues.color,
    fontFamily: theme.typographyValues.fontFamily,
    fontStyle: theme.typographyValues.fontStyle,
  ...
  theme.typographyElements.buttonPrimary = (0, _defineProperty2.default)({
  ...
  theme.typographyElements.linkPrimary = (0, _defineProperty2.default)({
  ...
  theme.typographyElements.linkSecondary = (0, _defineProperty2.default)({
    color: theme.secondaryPalette.colorVariables.DARKER_BLUE,
    fontFamily: theme.typographyValues.fontFamily,
    fontStyle: theme.typographyValues.fontStyle,
    fontWeight: theme.typographyValues.fontWeight,
